    ...
    <div class="container">
        ...
        <br>
                <div>
                    ...
                    <?php if(\Models\Studentupload::where('student_id', $student->id)->count() > 0): ?> 
                ...
                <div>
                    <?php $__currentLoopData = $student->uploads(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row" style="margin:2rem 0rem;">
                            <div class="col-md-4">
                                <img src="/assets/img/student/<?php echo e($item->file); ?>" style="width:100%">
                            </div>
                            <div class="col-md-8">
                                <h4><?php echo e($item->title); ?></h4>
                                <br>
                                <p> <strong>Verified By:</strong><?php echo e($item->verified_by); ?> </p>
                                <p> <strong>Remarks:</strong><?php echo e($item->remark); ?> </p>
                                <p>
                                    <a href="/student/upload/del/<?php echo e($item->id); ?>/" class="btn btn-danger">Delete</a>
                                </p>
                            </div>
                        </div>
