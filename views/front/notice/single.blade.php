@extends('front.app')
@section('title', 'Notices Single Page')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="feature-wrapper mb-30">
                        <div class="row">
                            <div class="col-md-5">
                                <a href="/assets/img/page/{{ $notice->image }}" title="click to view large" target="_blank">
                                    <img src="/assets/img/page/{{ $notice->image }}" style="width:100%"/>
                                </a>
                            </div>
                            <div class="col-md-7">
                       ...
                       <div class="notice-design">
                        <div class="list-group-item list-group-item-action flex-column align-items-start" style="background-color: #24355C; border-color: transparent;">
                                    <div class="w-100 justify-content-between">
                                      <h5 class="mb-2 h5 text-center hr-text" style="color: #ffffff; font-family: noticeheader;">{{ $notice->title }}</h5>
                                    </div>
                                    <p class="mb-2 text-center" style="color: #ffffff; font-family: noticebody;">
                                      {{ $notice->description }}
                                    </p>

                                    <small class="text-warning" style="text-align: left;"><i class="fa fa-calendar-plus-o" aria-hidden="true"></i> - {{ $notice->published }}</small>
                                  <small class="text-info" style="float: right; color: #f80!important;"><i class="fa fa-user-circle" aria-hidden="true"></i> - {{ $notice->publisher }}</small>
                          </div>      
                       </div>                        
                       @endforeach
                </div>
