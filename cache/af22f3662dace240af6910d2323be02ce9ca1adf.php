            ...
            <div style="padding: 3rem 0.5rem;">
                <div class="row">
                        ...
                        <section>
                            ...
                            <div class="tab-content" id="myTabContent" style="    box-shadow: 0px 0px 10px 0px black;margin-top: 0.5rem;">
                                            ...
                                            <ul class="p-0">
                                                <?php $__currentLoopData = \Models\Notice::orderBy('created_at', 'desc')->take(5)->get();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  ...
                                                  <li class="notice-list">
                                                     <span class="s-n">
                                                        <?php echo e($notice->getdate()->format('d')); ?>
                                    ...
                                    <?php else: ?>
                                        <div class="row row-eq-height">
                                            ...
                                            <div class="col-md-12 col-sm-12 h-100">
                                                <h3 class="mb-4">Latest Notice</h3>
                                                <ul class="p-0">
                                                    <?php $__currentLoopData = \Models\News::orderBy('created_at', 'desc')->take(4)->get();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <article class="post clearfix campaign mb-30">
                                                        <div class="entry-header">
                                                            <div class="post-thumb thumb" style="max-height:295px;overflow:hidden;">
                                                                <a href="/news/<?php echo e($new->id); ?>/"><img src="/<?php echo e($new->photo); ?>" alt="" class="img-responsive img-fullwidth" ></a>
                                                            </div>
                                                            <div
                                                                class="entry-date media-left text-center flip bg-theme-colored p-3">
                                                                <ul>
                                                                    <li class="font-16 text-white font-weight-600">
                                                                        <?php echo e($new->getdate()->format('d')); ?></li>
                                                                    <li class="font-12 text-white text-uppercase"><?php echo e($new->getdate()->format('F')); ?>
                                                                ...
                                                                <div class="media-body pl-0">
                                                                    <div class="event-content pull-left flip">
                                                                        <h3 class="entry-title text-white text-uppercase m-0 mt-5"><a
                                                                                href="/news/<?php echo e($new->id); ?>/"><?php echo e($new->title); ?> </a></h3>
                                                                        <span class="mb-10 text-gray-darkgray mr-10"><i
                                                                                class="fa fa-user-circle mr-1 text-theme-colored"></i><?php echo e($new->publisher); ?></span>
                                                                                <br>
                                                                        <span class="mb-10 text-gray-darkgray mr-10"><i
                                                                                class="fa fa-calendar-plus-o mr-1 text-theme-colored"></i><?php echo e($new->published); ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <p class="mt-5"></p>
                                ...
                                <div class="tab-pane " id="admission" role="tabpanel" aria-labelledby="contact-tab">
                                    <?php $__currentLoopData = \Models\Openadmission::where('enabled',1)->orderBy('created_at', 'desc')->take(5)->get();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>        
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php $__currentLoopData = \Models\Member::take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="shadow" >
                                <img class="img-fullwidth" src="\assets\img\page\<?php echo e($member->image); ?>">
                                <div class="card-title p-1 text-center">
                                    <h4><?php echo e($member->desig); ?> </h4>
          ...
          <div class="section-content">
            <div class="row">
              <div class="col-md-6">
                ...
                <?php $__currentLoopData = Models\Event::orderBy('id', 'desc')->take(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="row">
                    <div class="col-xs-2 col-md-3 pr-0">
                      <div class="event-date text-center bg-theme-colored border-1px p-2 sm-custom-style">
                        <ul>
                          <li class="font-18 text-white font-weight-700"><?php echo e($event->getdate()->format('F')); ?></li>
                          <li class="font-16 text-white text-center text-uppercase"> <?php echo e($event->getdate()->format('d')); ?></li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-xs-9 pr-10 pl-10">
                      <div class="event-content mt-0 p-0 pb-0 pt-0">
                        <h4 class="media-heading font-weight-600"><a href="/"><?php echo e($event->title); ?></a></h4>
                        <p class="mb-0">
                  ...
                  <div class="col-md-12">
                    <div class="box-hover-effect play-button">
                      <div class="effect-wrapper">
                        <div class="thumb">
                          <img class="img-fullwidth" src="<?php echo e($image!=""?"/assets/img/page/".$image:"\assets\img\student\1600092479_projectimage.jpg"); ?>" alt="project">
                        </div>
                        <div class="overlay-shade bg-theme-colored"></div>
                        <div class="video-button"></div>
                        <a class="hover-link" data-lightbox-gallery="youtube-video" href="<?php echo e($link==""?"#":$link); ?>" title="Youtube Video">Youtube Video</a>
                      </div>
                    </div>             
                  </div>
                </div>
      ...
      <?php if($popup!=null): ?>
        ...
        <div class="modal-dialog modal-dialog-centered  " role="document">
            <div class="modal-content"
                style="background:url('/assets/img/page/<?php echo e($popup->image); ?>');
