...
$.fn.zabuto_calendar = function (b) {
    ...
    var a = $
        .fn
        .zabuto_calendar_language(c.language);
    c = $.extend({}, c, a);
    this.each(function () {
        var i = $(this);
        i.attr(
        ...
        function f(y) {
            var w = $(
                '<div class="legend" id="' + y.attr("id") + '_legend"></div>'
            );
                        ...
                        if ("type" in E) {
                            ...
                            switch (E.type) {
                                ...
                                case "block":
                                    ...
                                    w.append(
                                        '<span class="legend-' + E.type + '"><ul class="legend"><li class="' + A + '"><' +
                                        '/li></ul>' + D + "</span>"
                                    );
                                    break;
                                case "list":
        ...
        function q(E, D, G, M) {
            ...
            var A = $('<span><i class="fas fa-arrow-circle-left"></i></span>');
            var Q = $('<span><i class="fas fa-arrow-circle-right"></i></span>');
            if (typeof(L) === "object") {
                if ("prev" in L) {
                    A.html(L.prev)
                }
        ...
        function g(z, F, E, H) {
            ...
            var C = $(
                '<div class="modal-footer" id="' + z + '_modal_footer"></div>'
            );
            ...
            w.append(A);
            var B = $(
                '<div class="modal fade" id="' + z + '_modal" tabindex="-1" role="dialog" aria-' +
                'labelledby="' + z + '_modal_title" aria-hidden="true"></div>'
            );
            B.append(w);
            B.data("dateId", z);
            B.attr("dateId", z);
        ...
        function s(x, w, A) {
            ...
            $
                .ajax({type: "GET", url: z.url, data: y, dataType: "json"})
                .done(function (B) {
                    var C = [];
                    $.each(B, function (E, D) {
                        C.push(B[E])
        ...
        function t(z, w, x) {
            return w > 0 && w < 13 && z > 0 && z < 32768 && x > 0 && x <= (
                new Date(z, w, 0)
            ).getDate()
        }
        function n(y, A) {
