...
<?php $__env->startSection('title',"Popup"); ?>
<?php $__env->startSection('content'); ?>
    ...
    <form method="post" action="/admin/popup/save/" enctype="multipart/form-data">
       ...
       <div class="form-group">
           <input type="checkbox" data-role="checkbox" <?php echo e($status==1?'checked':""); ?>  data-caption="Enabled" name="status" value="1"> 
       </div>
        <div class="form-group">
            <label>Description</label>
            <textarea data-role="textarea" name="body" id="body" ><?php echo e($page); ?></textarea>
        </div>
           <div>
