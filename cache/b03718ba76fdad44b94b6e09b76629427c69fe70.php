...
<?php $__env->startSection('content'); ?>
    ...
    <h4>Edit <?php echo e($page->title); ?></h4>
    <hr />
    <form method="post" action="/admin/page/edit/<?php echo e($page->id); ?>/" enctype="multipart/form-data">
        <input type="hidden" name="type" value="<?php echo e($page->type); ?>">
        <div class="form-group">
            <label>Title</label>
            <input type="text" name="title" placeholder="Enter Title" value="<?php echo e($page->title); ?>" required/>
        </div>
<br>
        <div class="form-group">
            <label>Description</label>
            <textarea data-role="textarea"  name="body" id="body"><?php echo e($page->body); ?></textarea>
        </div>
        <br>
        <div>
            ...
            <div class="row" id="images">
                        ...
                        <div style="position: relative">
                            <div >
                                ...
                                <img src="/assets/img/page/<?php echo e($page->image); ?>" alt="..." id="gal_img" 
                            ...
                            <div style="position: absolute;top:0px;right:0px;">
                                ...
                                document.getElementById('gal_img').src='/assets/img/page/<?php echo e($page->image); ?>';
                                "
                                >Clear</span>
                            </div>
                        </div>
