          ...
          <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              ...
              ?>
                ...
                ?>
              <!-- SLIDE 1 -->
              <li data-index="rs-{{$slidercount}}" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="/{{$slid->image}}" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="{{$slid->caption}}">
                <!-- MAIN IMAGE -->
                <img src="/{{$slid->image}}" alt="" data-bgposition="top 40%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme rs-parallaxlevel-0" 
                  id="slide-{{$slidercount}}-layer-{{$layercount++}}" 
                ...
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  ...
                  data-responsive_offset="on" 
                  style="z-index: 7; white-space: nowrap;">
                  {{-- <a href="{{$slid->link}}" class="btn btn-default btn-theme-colored2 btn-xl">{{$slid->button}}</a>  --}}
                </div>
              </li>
              <?php $slidercount+=1;?>
            @endforeach
