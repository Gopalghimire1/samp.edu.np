@extends('front.app')
@section('title', 'Result Detail Page')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="feature-wrapper mb-30">
                        <div class="row">
                            <div class="col-md-5">
                                <a href="/{{ $result->file }}" title="click to view large" target="_blank">
                                    <img src="/{{ $result->file }}" style="width:100%" alt="Click here to view.."/>
                                </a>
                            </div>
                            <div class="col-md-7">
                                ...
                                <div style="padding:.7rem 0;">
                                    <small class="text-info pull-right" style="color: #f80!important;"><i class="fa fa-user-circle"
                                            aria-hidden="true"></i> - {{ $result->publisher }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
