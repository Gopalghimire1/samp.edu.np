...
<section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/assets/img/bg2.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-white font-36"><?php echo e($faculty->name); ?> Faculty </h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home </a></li>
                <li class="active">Pages </li>
                <li class="active"><?php echo e($faculty->name); ?>  </li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <h2 class="text-uppercase line-bottom-double-line-centered mt-0"><?php echo e($faculty->name); ?>   <span class="text-theme-colored2">Faculty </span></h2>
              <p><br></p>
            </div>
          </div>
        </div>
...
<!-- <div class="container ">
        <div class="row jumbotron" style="padding:4rem; 0">
                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <div class="col-sm-2 col-md-2">
                    <img src="/<?php echo e($res->photo); ?>"
                       alt="" class="img-rounded img-responsive" height="150px;" width="100%;"/>
                   </div>
                   <div class="col-sm-4 col-md-4">
                       <blockquote>
                         <p class="text-danger font-weight-bold" style="font-family:noticeheader;"><b><?php echo e($res->name); ?></b>
                        </p> <small class="text-info"><cite title="Source Title"> <?php echo e($res->adress); ?> <i class="fas fa-map-marker-alt"> </i></cite></small>
                       </blockquote>
                       <p class="text-info" style="font-family:noticebody;"> <i class="fas fa-phone" ></i> <?php echo e($res->phone); ?>

                           <br />
                           <i class="fas fa-envelope-square"></i> <?php echo e($res->email); ?>

                           <br
                           /> <i class="fas fa-graduation-cap"></i><?php echo e($res->education); ?>
