...
<?php $__env->startSection('content'); ?>
    ...
    <h4>Edit Member</h4>
    <hr />
    <form method="post" action="/admin/member/edit/<?php echo e($data->id); ?>/" enctype="multipart/form-data">

        <div class="form-group">
            <label>Title</label>
            <input type="text" name="name" placeholder="Enter Name" required value="<?php echo e($data->name); ?>"/>
        </div>
<br>
        <div class="form-group">
            <label>Designation</label>
            <input type="text" name="desig" placeholder="Enter Designation" required value="<?php echo e($data->desig); ?>"/>
            ...
            <div class="row" id="images">
                        ...
                        <div style="position: relative">
                            <div >
                                ...
                                <img src="/assets/img/page/<?php echo e($data->image); ?>" alt="..." id="gal_img" 
                            ...
                            <div style="position: absolute;top:0px;right:0px;">
                                ...
                                document.getElementById('gal_img').src='/assets/img/page/<?php echo e($data->image); ?>';
                                "
                                >Clear</span>
                            </div>
                        </div>
